...
function ToggleObj_2()
{
    ...
    document.getElementById("Abstimmungen_Ansehen").style.visibility = "hidden"; /*hidden vorher*/
    document.getElementById("Abstimmungen_Erstellen").style.visibility = "visible"; /*visible vorher*/
}
